    ...
    <section className="bg-gradient-to-br  from-gray-900 via-black to-gray-800 text-white py-12 lg:py-20 relative overflow-hidden" 
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
            ...
            <div className="space-y-5 text-gray-200">
              ...
              {isReadMore && (
                <>
                  ...
                  {/* Mobile Image Gallery - Only shown when Read More is clicked */}
                  <div className="lg:hidden w-full mt-6">
                    <div className="relative rounded-3xl overflow-hidden shadow-2xl border-2 border-gray-800">
                      ...
                      {/* Bottom Banner */}
                      <div className="bg-gradient-to-r from-red-600 via-red-700 to-blue-700 text-white text-center py-4 relative overflow-hidden">
                        <div className="absolute inset-0 bg-black opacity-20"></div>
                        <h3 className="text-sm font-bold uppercase tracking-[0.15em] relative z-10">
                  ...
                  <button 
                    ...
                    className="text-red-500 hover:text-red-400 font-semibold text-sm uppercase tracking-wider transition-colors duration-200 flex items-center gap-2 mt-4"
                  >
                    Read Less
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Right Section: Image Gallery - Hidden on mobile, always shown on desktop */}
