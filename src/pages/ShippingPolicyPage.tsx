...
const iconMap: { [key: string]: any } = {
  "Shipping Rates": CreditCard,
  "Order Processing": Clock,
  "Delivery Time": MapPin
};
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
        {/* Hero Section */}
          ...
          <div className="container mx-auto max-w-5xl relative z-10">
            <div className="flex items-center justify-center space-x-4 mt-10 mb-4">
              <Package className="h-14 w-14 text-blue-100" />
            </div>
            ...
            <p className="text-xl text-center text-gray-300 max-w-2xl mx-auto">
              Fast, reliable delivery across India with transparent shipping terms
            </p>
          </div>
        </div>
            ...
            {policy?.sections && policy.sections.length > 0 ? (
              <div className="space-y-6">
                {policy.sections.map((section, index) => {
                  const Icon = iconMap[section.title] || Package;
              ...
              <div className="text-center py-20">
                <div className="bg-white rounded-2xl shadow-lg p-12 max-w-2xl mx-auto">
                  ...
                  <p className="text-lg text-gray-700 mb-2">
                    No shipping policy content available yet.
                  </p>
              ...
              <div className="flex items-start space-x-5">
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    If you have any questions about shipping or need assistance tracking your order, 
